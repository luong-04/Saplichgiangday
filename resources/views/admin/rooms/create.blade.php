...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Thêm Phòng học</h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Khởi tạo phòng học và cấu hình sức chứa</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity', 45) }}" min="1" required
