...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Thêm Lớp học</h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Tạo lớp học mới và phân bổ vào các ca giảng dạy</p>
    </div>
