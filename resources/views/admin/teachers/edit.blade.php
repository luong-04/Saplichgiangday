...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Cập nhật Giáo viên</h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Chỉnh sửa thông tin định danh và phân công</p>
    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="short_code" name="short_code" value="{{ old('short_code', $teacher->short_code) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="lookup_code" name="lookup_code" value="{{ old('lookup_code', $teacher->lookup_code) }}" required
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" id="quota" name="quota" value="{{ old('quota', $teacher->quota) }}" min="0" required
                        ...
                        <div>
                            ...
                            <input type="number" id="max_periods_per_day" name="max_periods_per_day" value="{{ old('max_periods_per_day', $teacher->max_periods_per_day) }}" min="1" max="10" required
                    ...
                    <div>
                        ...
                        <div class="flex gap-6">
                            @php $cachedShifts = old('teaching_shifts', $teacher->teaching_shifts ?? []); @endphp
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="teaching_shifts[]" value="morning" class="w-4 h-4 text-blue-600 rounded" {{ is_array($cachedShifts) && in_array('morning', $cachedShifts) ? 'checked' : '' }}>
                                <span class="text-sm font-medium text-slate-700">Sáng</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="teaching_shifts[]" value="afternoon" class="w-4 h-4 text-blue-600 rounded" {{ is_array($cachedShifts) && in_array('afternoon', $cachedShifts) ? 'checked' : '' }}>
