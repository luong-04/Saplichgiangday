...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-800 tracking-tight">Thêm Nhóm phòng</h1>
        <p class="text-sm text-slate-500 font-medium mt-1">Khởi tạo phân loại phòng học</p>
    </div>
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                    ...
                    placeholder="VD: Phòng Tin học, Phòng Hóa học...">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                    class="w-full px-3 py-2 border @error('description') border-red-500 @else border-slate-200 @enderror rounded-lg focus:outline-none focus:border-blue-500 bg-slate-50 focus:bg-white transition-colors"
                    placeholder="VD: Các phòng trang bị máy tính dùng chung cho khối tự nhiên">{{ old('description') }}</textarea>
